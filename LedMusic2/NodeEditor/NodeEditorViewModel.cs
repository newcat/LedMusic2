...
namespace LedMusic2.NodeEditor
{
    public class NodeEditorViewModel : VMBase, IExportable, IDisposable
    {
        ...
        private TemporaryConnection _temporaryConnection;
        public TemporaryConnection TemporaryConnection
        {
        ...
        public ObservableCollection<TemporaryConnection> TemporaryConnectionOC
        {
            get { return new ObservableCollection<TemporaryConnection>() { TemporaryConnection }; }
        }
        ...
        public void CreateTemporaryConnection(NodeInterface sender)
        {
            ...
            if (sender.IsInput && Connections.FirstOrDefault((x) => x.Output == sender) != null)
            {
                ...
                TemporaryConnection = new TemporaryConnection(input, this);
                NodeConnectionHelper.Instance.ConnectionOrigin = input;
            }
            else
            {
                TemporaryConnection = new TemporaryConnection(sender, this);
